...
Recode : Aditya
Youtube Author : Aditya
Youtube Recode : Aditya
...
cd /sdcard
cd BaseV2
git clone https://github.com/Aditya/node_modules
node .
...
https://github.com/Aditya/KuzaBase
...
let ownername = '*Aditya*' //NAMA OWNER
let owner = '6281312533066' // NOMOR OWNER
let symbol = '*☛*'
let faketeks = `*｢ WLBOT ｣ 冬*` 
...
const ytAditya = "6282293295376@s.whatsapp.net"
...
const YtAditya = fs.readFileSync ('pee.jpg')
...
const fakeyt = (teks) => { 
kuza.sendMessage(from, teks, text,{contextInfo :{text: 'hi', "forwardingScore": 1000000000, isForwarded: false, sendEphemeral: false, "externalAdReply": { "title": `hallo ${pushname}🗿` , "body": `Aditya`, "mediaType": "2", "thumbnailUrl": "https://c.top4top.io/p_2087f30hj1.jpeg", "mediaUrl": "https://tps.com/channel/UCJPqI5eVhKPXPL2V8y6pIDA", "thumbnail": fs.readFileSync('pee.jpg'), "sourceUrl": "", },mentionedJid:[sender]}, quoted : fstatus})};
...
const fstatus = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "Aditya", 'jpegThumbnail': fs.readFileSync('pee.jpg')}}}
...
costum(buffer, sticker, Verived, `Aditya`)
fs.unlinkSync(media)
fs.unlinkSync(ran)
})
...
case 'donasi':
case 'sedekah':
reply(`Yuk donasi biar bot semakin berkembang!

GOPAY : 081312533066
DANA : 081312533066 
BCA : (minta rekening ke owner)

Semoga yang donasi makin banyak rezeki, maaacii <3😘`)
break
case 'owner':
members_ids = []
